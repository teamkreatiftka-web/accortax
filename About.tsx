...
const About: React.FC = () => {
  return (
    <div className="bg-white dark:bg-[#0A0A0A] min-h-screen transition-colors duration-500">
      ...
      {/* Header: Clean White Theme with Texture */}
      {/* Adjusted padding top for mobile: pt-28 instead of pt-40 */}
      <div className="bg-white dark:bg-black pt-28 md:pt-40 pb-16 md:pb-20 rounded-b-[2.5rem] relative overflow-hidden border-b border-gray-100 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          {/* Text changed to brand-dark (black) */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20 pb-20">
        ...
        {/* 2.1 Profil Perusahaan (Glass Card) */}
        <section className="glass-panel rounded-[2rem] p-6 md:p-12 mb-12 shadow-xl backdrop-blur-xl relative overflow-hidden">
          ...
          {/* Mobile: Flex-col-reverse (Image on top/middle, text below) usually better, or just col. Kept col for standard flow */}
        ...
        {/* 2.2 Visi & 2.3 Misi (Bento Grid) */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {/* Visi Card - Kept Dark for Contrast as it is a specific card */}
          ...
          {/* Misi Card - Frosted Glass Light */}
          <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-glass md:col-span-2 border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-8 relative z-10">
              ...
              <h2 className="text-2xl font-bold font-heading text-brand-dark tracking-tight">Misi Kami</h2>
            </div>
        ...
        {/* 2.4 Nilai Perusahaan - Glass Cards */}
        <section className="mb-24 relative">
            {/* Background Abstract Blob for values */}
...
const MissionItem = ({ text }: { text: string }) => (
  <div className="flex items-start gap-4 p-4 md:p-5 bg-white/50 backdrop-blur-sm rounded-2xl transition-all border border-gray-100 hover:border-gray-200 hover:bg-white">
    <div className="mt-0.5 text-brand-red flex-shrink-0">
      <CheckCircle2 size={20} />
    </div>
    <span className="text-gray-600 font-medium text-sm leading-relaxed">{text}</span>
  </div>
);
...
const ValueCard = ({ title, desc, icon, color }: { title: string, desc: string, icon: React.ReactNode, color: string }) => (
  <div className="glass-panel p-6 md:p-8 rounded-3xl hover:border-brand-red/20 transition-all text-center group hover:-translate-y-1">
    ...
    <h3 className="text-base md:text-lg font-bold font-heading text-brand-dark mb-2 tracking-tight">{title}</h3>
