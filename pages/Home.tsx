...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col font-sans bg-texture-noise selection:bg-saas-primary selection:text-white transition-colors duration-500 min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start z-20">
              ...
              {/* Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold font-heading text-saas-dark dark:text-white leading-[1.1] tracking-tight mb-6 drop-shadow-sm animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              ...
              {/* Subheadline */}
              <p className="text-sm md:text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl lg:max-w-xl leading-relaxed animate-fade-in-up font-medium px-2 lg:px-0" style={{animationDelay: '0.2s'}}>
      ...
      {/* 3. PAIN POINTS */}
      <section className="py-20 md:py-20 bg-[#050505] rounded-t-[2.5rem] -mt-8 relative z-30 overflow-visible border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-24 md:gap-20">
            
            {/* Left Content (Visual Storytelling) */}
            <div className="lg:w-1/2 order-2 lg:order-1 relative min-h-[300px] flex items-center justify-center">
              <div className="lg:sticky lg:top-32 w-full max-w-[340px] sm:max-w-[420px] mx-auto h-[280px] md:h-[340px] relative perspective-[1000px] flex flex-col justify-center items-center">
                  ...
                  {/* Floating Cards - Kept as is, they look good dark */}
                  <div className="absolute -top-12 left-0 md:-top-4 md:-left-4 w-[90%] md:w-[90%] z-10 transform -rotate-[6deg] opacity-70 scale-95 hover:opacity-100 hover:z-30 hover:scale-105 hover:rotate-0 transition-all duration-500 ease-out hover:shadow-2xl blur-[1px] hover:blur-0 cursor-pointer">
                     <div className="relative bg-[#0F0F0F] border border-white/10 rounded-[1.5rem] p-5 shadow-2xl flex items-center gap-3 md:gap-5">
                  ...
                  <div className="absolute -bottom-12 right-0 md:-bottom-4 md:-right-4 w-[90%] md:w-[90%] z-10 transform rotate-[6deg] opacity-70 scale-95 hover:opacity-100 hover:z-30 hover:scale-105 hover:rotate-0 transition-all duration-500 ease-out hover:shadow-2xl blur-[1px] hover:blur-0 cursor-pointer">
...
const ServiceCard = ({ index, title, description, icon, link, rotateClass = "" }: { index: number, title: string, description: string, icon: React.ReactNode, link: string, rotateClass?: string }) => (
  <Link to={link} className={`block group relative w-full h-full transition-all duration-500 ${rotateClass} hover:rotate-0 hover:scale-[1.02] hover:z-20 transform-gpu`}>
