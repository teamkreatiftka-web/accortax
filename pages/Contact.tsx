          ...
          <div className="lg:col-span-5 space-y-8">
             <div className="bg-gray-50 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-[2rem] p-6 md:p-8 shadow-xl">
                ...
                <div className="space-y-8">
                  <ContactItem icon={<MapPin />} title="Alamat Kantor" content="Gedung Perkantoran ABC, Lt. 3, Jl. Jend. Sudirman No. Kav 12, Jakarta Selatan 12345" />
                  <ContactItem icon={<Mail />} title="Email" content="contact@accortax.com" />
                  <ContactItem icon={<Phone />} title="Telepon / WhatsApp" content="+62 812 3456 7890" />
                  <ContactItem icon={<Clock />} title="Jam Operasional" content="Senin - Jumat: 09.00 - 17.00 WIB" />
                </div>
             </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" id="name" required className="w-full px-6 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red outline-none transition-all text-brand-dark dark:text-white placeholder-gray-400 font-medium" placeholder="Nama Anda" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="company" className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Perusahaan</label>
                    <input type="text" id="company" className="w-full px-6 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red outline-none transition-all text-brand-dark dark:text-white placeholder-gray-400 font-medium" placeholder="PT / CV" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Email</label>
                  <input type="email" id="email" required className="w-full px-6 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red outline-none transition-all text-brand-dark dark:text-white placeholder-gray-400 font-medium" placeholder="email@anda.com" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="service" className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Layanan</label>
                  <div className="relative">
                    <select id="service" className="w-full px-6 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red outline-none transition-all text-brand-dark dark:text-white appearance-none cursor-pointer font-medium">
                      <option>Jasa Akuntansi / Pembukuan</option>
                      <option>Jasa Perpajakan</option>
                      <option>Konsultasi Bisnis</option>
                      <option>Lainnya</option>
                    </select>
                    <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500"><ArrowRight size={20} className="rotate-90" /></div>
                  </div>
                </div>
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Pesan</label>
                  <textarea id="message" rows={4} required className="w-full px-6 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red outline-none transition-all text-brand-dark dark:text-white placeholder-gray-400 resize-none font-medium" placeholder="Ceritakan sedikit tentang kebutuhan bisnis Anda..."></textarea>
                </div>
                <button type="submit" className="w-full bg-brand-red text-white font-bold py-5 rounded-xl hover:bg-red-700 transition-all flex items-center justify-center gap-2 shadow-lg shadow-red-500/30 hover:shadow-red-500/40 active:scale-[0.98] transform duration-200 text-lg tracking-wide">
